      ...
      <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
        <Reveal>
          <h2 className="text-balance text-3xl font-extrabold text-slate-800 sm:text-4xl">
            Agenda tu visita y conoce Amatista, Punta Azul en persona.
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-pretty text-lg text-slate-600">
            Financiamiento directo a 5 años (10% anual), sin trámite
            bancario — o si prefieres, te ayudamos a tramitar tu crédito
            bancario sin costo.
          </p>
        </Reveal>
