      ...
      <div className="mx-auto grid min-h-[85vh] max-w-6xl items-center gap-10 px-4 pb-16 pt-28 sm:px-6 lg:grid-cols-2 lg:gap-14 lg:pb-20 lg:pt-32">
        <div className="flex flex-col gap-6">
          ...
          >
            ...
            Punta Azul · Lienzo Charro, Rosarito
          </motion.span>
          ...
          >
            Casa nueva de 3 niveles con roof deck y vista al mar, dentro del fraccionamiento Punta Azul.
          </motion.h1>
          ...
          >
            Amatista, casa de 3 recámaras y 4 baños de 157 m² de
            construcción, en el fraccionamiento privado Punta Azul (Lienzo
            Charro), con alberca, gimnasio, canchas de tenis y seguridad
            24/7.
          </motion.p>
